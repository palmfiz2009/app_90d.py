...
# 3. セッション状態初期化
# ==========================================
if 'init_90d_perfect_v5' not in st.session_state:
    ...
    defaults = {
        ...
        "cytology_90": "選択してください", "cd_grade_90": "選択してください", "cd_date_90": None, "cd_detail_90": "",
        "has_ctcae_90": False, "ae_status": "", "adj_plan_90": "選択してください", "adj_other_90": "",
        "adj_start_90": None, "adj_end_90": None, "adj_ongoing_90": False,
        "pfs_intra_status": "未選択", "pfs_intra_date": None, "pfs_intra_site": [], "pfs_intra_site_other": "",
        "pfs_intra_tx": [], "pfs_intra_tx_other": "", "intra_op_date_90": None, "intra_tx_start_90": None,
        "intra_tx_end_90": None, "intra_tx_ongoing_90": False, "pfs_intra_path_90": "",
        "pfs_recist_status": "未選択", "pfs_recist_date": None, "pfs_recist_site": [], "pfs_recist_site_other": "",
        "pfs_recist_tx": "選択してください", "pfs_recist_tx_detail": "", "extra_op_date_90": None,
        "extra_tx_start_90": None, "extra_tx_end_90": None, "extra_tx_ongoing_90": False,
    ...
    st.session_state['init_90d_perfect_v5'] = True
...
# 🔴 UI全体を form で包むことでボタンのAPIエラーを解消
    ...
    with tab2:
        ...
        with c2:
            ...
            if st.session_state.adj_plan_90 not in ["選択してください", "無治療（経過観察）"]:
                ...
                st.session_state.adj_start_90 = ax1.date_input("開始日*", value=st.session_state.adj_start_90)
                ...
                if not st.session_state.adj_ongoing_90:
                    st.session_state.adj_end_90 = ax2.date_input("終了日*", value=st.session_state.adj_end_90)
    ...
    with tab3:
        ...
        with c2:
            ...
            if st.session_state.pfs_recist_status == "あり":
                st.session_state.pfs_recist_date = st.date_input("尿路外再発診断日*", value=st.session_state.pfs_recist_date)
...
if submitted:
    ...
    if d.status_alive_90 == "未選択": err.append("・生存状況")
...
--- 4. 生存状況 ---
生存状況: {d.status_alive_90} ({'確認日' if d.status_alive_90=='生存' else '死亡日'}: {d.final_visit_date_90 if d.status_alive_90=='生存' else d.death_date_90})
"""
        if send_email(rep, d.patient_id, d.facility_name, d.reporter_email):
            ...
            # JSON保存用
            json_payload = {k: str(v) for k, v in d.items() if not k.startswith('init')}
